"""
Test script for the Vector Database module
"""
import json
import numpy as np
...
def test_vector_database():
    ...
    print("🧪 Testing PrivAI Vector Database")
    print("=" * 50)
    ...
    try:
        ...
        sample_chunks = [
            ...
            {
                "text": "Vector embeddings enable semantic search capabilities.",
                "metadata": {
                    "source_file": "technical_specs.pdf",
                    "page_number": 4,
                    "chunk_index": 1,
            ...
            {
                "text": "All data processing happens locally on the user's machine.",
                "metadata": {
                    "source_file": "privacy_policy.pdf",
                    "page_number": 2,
                    "chunk_index": 1,
        ...
        print(f"   Chunk IDs: {chunk_ids[:3]}...")  # Show first 3 IDs
